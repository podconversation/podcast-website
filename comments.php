...
<html lang="en">
  ...
  <div class="container px-5">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
      ...
      <!-- End Logo Image -->
      <a class="navbar-brand" href="comments.php">PodConversation</a>
					...
					<div class="card shadow-sm my-2">
					  ...
					  <div class="card-body">
						<blockquote class="blockquote mb-0">
						  <p class="text-capitalize"><?php echo $row['comment']; ?></p>
				...
				<div class="card border-dark">
				  ...
				  <div class="card-body">
					...
					<div class="d-grid gap-2 ms-0 pt-3">
					  <button type="submit" name="post" class="btn btn-primary">Post a Comment</button>
					</div>
					</p>
				  </div>
				</div>
