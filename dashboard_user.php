...
<html lang="en">
  ...
  <div class="container px-5">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
      ...
      <!-- End Logo Image -->
      <a class="navbar-brand" href="dashboard_user.php">PodConversation</a>
    ...
    <div class="container pt-5">
      <div class="row">
        ...
        <div class="row"><h1 class="text-center text-light large-text"><b>WELCOME TO</b></h1></div>
          <div class="row"><h1 class="text-center text-light large-text"><b>PODCONVERSATION!</b></h1></div><br><br><br>
